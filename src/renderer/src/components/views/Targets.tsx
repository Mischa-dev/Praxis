// Targets view — renders the generic EntityBoard for the primary entity type.
// Keeps backward compat with navigate('targets') calls throughout the app.
...
export default function Targets(): React.JSX.Element {
  ...
  const handleEntityClick = (entity: EntityRecord): void => {
    ...
    navigate('target-detail', { entityType: primaryType?.id, entityId: entity.id })
  }
